...
"""
mask.py を流用
exportor の dm_env.converters.get において
apply_colormap=False を指定しただけ
"""
...
@exporter(name='Segmentation gray mask', ext='ZIP', version='1.1')
def _export(dst_file, task_data, save_images=False):
    ...
    with TemporaryDirectory() as temp_dir:
        dm_env.converters.get('voc_segmentation').convert(extractor,
            ...
            apply_colormap=False, label_map=make_colormap(task_data))

        make_zip_archive(temp_dir, dst_file)

@importer(name='Segmentation gray mask', ext='ZIP', version='1.1')
